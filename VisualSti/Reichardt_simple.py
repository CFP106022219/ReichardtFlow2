...
class RH(object):
    def __init__(self,
        ...
        self.fl = fl
        self.fh = fh
        self.lowpassA1 = signal.convolve(inputframe, self.gb_A1, "same")
        self.lowpassA2 = signal.convolve(inputframe, self.gb_A2, "same")

    def run(self, input):
        self.convA1 = signal.convolve(input, self.gb_A1, "same")
        self.convA2 = signal.convolve(input, self.gb_A2, "same")
